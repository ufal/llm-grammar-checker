...
def main_eval(args):
    ...
    with open(args.eval) as f:
        for auto_corr, gold_line in zip(sys.stdin, f):
            ...
            print("NUMBER OF DETECTED ERRORS:\t", len(a["info"]["errors"]), file=sys.stderr)
            print("ORIG:\t", auto_or, file=sys.stderr)
            print("AUTO CORRECTED:\t", auto_corr, file=sys.stderr)
            print("GOLD:\t", gold_corr, file=sys.stderr)
            print("HIGHLIGHTED AUTO ERRORS:\t", a["info"]["highlighted_errors"], file=sys.stderr)
            print("HIGHLIGHTED GOLD ERRORS:\t", g["info"]["highlighted_errors"], file=sys.stderr)
            print("HIGHLIGHTED AUTO CORRECTION:\t", a["info"]["highlighted_corrections"], file=sys.stderr)
            print("HIGHLIGHTED GOLD CORRECTION:\t", g["info"]["highlighted_corrections"], file=sys.stderr)
